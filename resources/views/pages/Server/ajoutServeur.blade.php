...
<body>
      <div class="container">
             <div class="form-title">
                    <span>Ajout Server/Switch/Routeur</span>
             </div>
             @if(session('success'))
             ...
             @endif
             <form action="{{ route('server_add') }}" method="POST" enctype="multipart/form-data">
              @csrf
                 <div class="main-material-info">
                    ...
                    <div class="material-input-box">
                        ...
                        <input type="text" name="emplacement" id="emplacement" placeholder="Propriétaire du matériel">
                    </div>
                    <div class="material-input-box">
