...
<body>
      <div class="container">
             ...
             @endif
             <form action="{{ route('domino_add') }}" method="POST" enctype="multipart/form-data">
              @csrf
                 <div class="main-material-info">
                    <div class="material-input-box">
                         <label for="designation">IMEI : </label>
                         <input type="text" name="imei" id="imei" placeholder="imei du matériel">
                    </div>
                    <div class="material-input-box">
                    ...
                    <div class="material-input-box">
                        ...
                        <input type="text" name="user" id="user" placeholder="L'utilisateur de l'imprimante">
                    </div>
                    <div class="material-input-box">
                    ...
                    <div class="material-input-box">
                        ...
                        <input type="text" name="service" id="service" placeholder="Remarque sur ce matériel">
                    </div>
                    <div class="material-input-box">
                        <label for="service">Operateur :</label>
                        <input type="text" name="operateur" id="operateur" placeholder="operateur ">
                    </div>
